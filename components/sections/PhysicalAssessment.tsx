...
export default function PhysicalAssessmentComponent({ assessment, onChange, readOnly = false, hideFunctionalCapacity = false, showCapacitiesMatrix = false, jobTitle, hoursPerDay, gender }: PhysicalAssessmentProps) {
